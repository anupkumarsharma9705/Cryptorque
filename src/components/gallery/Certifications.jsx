...
const certs = [
  {
    ...
    year: "2024",
    description: "Foundation in Core Java, OOP, Collections, and JDBC — the base everything else is built on.",
  ...
  },
  {
    ...
    year: "2024",
    description: "Frontend basics to understand how React UIs consume Spring Boot APIs — full contract awareness on both sides.",
  ...
  },
  {
    ...
    year: "2024",
    description: "Common attack vectors and best practices — directly applied when building the attack detection module in fintech-gateway.",
  ...
  },
  {
    ...
    year: "2025",
    description: "CVSS severity scoring and vulnerability lifecycle — informed the block/throttle threshold design in the risk scoring engine.",
  ...
  },
  {
    ...
    year: "2025",
    description: "GRC frameworks and data privacy principles — applied to the audit log schema design: every event captures actor, action, decision, and outcome.",
    ...
    <section id="certs" className="section-container">
      ...
      <div style={{ marginBottom: "56px" }}>
        ...
        <p style={{
          ...
          Each certification is applied — not collected. Every security and compliance cert maps directly to a specific module in the fintech-gateway codebase.
        </p>
